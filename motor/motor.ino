...
static const uint8_t usTrigPins[NUM_OF_ULTRASONIC_PIN] = {18, 16, 21 };  // F, L, R
static const uint8_t usEchoPins[NUM_OF_ULTRASONIC_PIN] = {19, 17, 4 };  // F, L, R
